...
if(isset($_REQUEST['add'])){
    ...
    $sql="insert into usertb(name,password,gender,addr,day,month,year,game,status) values ('$name','$pass','$gender','$add','$day','$month','$year','$game','$status')";
...
<html lang="en">
  ...
  <body>
    <form  name="myForm" action="./userform.php"  method="post" required>
    <div class="container">
      <div class="row">
            ...
            <div class="card text-left">
              ...
              <h2 class="text-center">User Form</h2>
                  ...
                  <div class="form-group">
                    ...
                    <button type="submit" name="view" class="btn btn-danger ml-5 pl-5 pr-5">View data</button>
                  </div>
