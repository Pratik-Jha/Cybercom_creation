...
if(isset($_REQUEST['login'])){
    ...
    $sql="insert into signintb(email,password)value('$email','$pass')";
...
<head>
  ...
  <body>
  <form name="myForm" action="./signin.php"  method="post" required>
    <div class="container">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">
                        ...
                        <div class="form-group pb-4">
                            ...
                            <button type="submit" onclick="next()" name="next" class="btn btn-primary  btn-block">Next</button>    
                        </div>
                  </div>
                </div>
            </div>
