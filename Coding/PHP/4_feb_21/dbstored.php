<?php
  ...
  if(isset($_REQUEST['add']))
  {
      ...
      $sql="insert into udata(name,password,addr,game,gender,age,image)value('$name','$pass','$add','$game','$gender','$age','$img')";
...
<html lang="en">
  ...
  <body>
  <form  name="myForm" action="./dbstored.php"  method="post" required>
    <div class="container">
      <div class="row">
