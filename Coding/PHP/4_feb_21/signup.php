...
if(isset($_REQUEST['add'])){
    ...
    $sql="insert into signuptb(fname,lname,day,month,year,gender,country,email,password,cfpassword) values ('$fname','lname','$day','$month','$year','$gender','$country','$email','$pass','$cpass')";
...
<html lang="en">
  ...
  <body>
      <form name="myForm" action="./signup.php"  method="post" required>
